...
let main_banner2 = document.getElementsByClassName('main_banner2')[0];

main_banner2.addEventListener('mouseenter', function(){
    clearInterval(auto_interval);
})
main_banner2.addEventListener('mouseleave', function(){
    auto_slide();
})